...
var args6369 = [];
var len__5730__auto___6373 = arguments.length;
var i__5731__auto___6374 = (0);
while(true){
if((i__5731__auto___6374 < len__5730__auto___6373)){
args6369.push((arguments[i__5731__auto___6374]));

var G__6375 = (i__5731__auto___6374 + (1));
i__5731__auto___6374 = G__6375;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args6369.length)].join('')));
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___6377 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__6368_SHARP_){
if(!((p1__6368_SHARP_ == null))){
if((false) || (p1__6368_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___6377){
var not_reactive_6378 = temp__4425__auto___6377;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_6378);
} else {
}
} else {
}
...
//# sourceMappingURL=subs.js.map?rel=1459672175558
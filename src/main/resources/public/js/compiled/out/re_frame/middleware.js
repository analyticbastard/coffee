...
var G__6419__i = 0, G__6419__a = new Array(arguments.length -  0);
while (G__6419__i < G__6419__a.length) {G__6419__a[G__6419__i] = arguments[G__6419__i + 0]; ++G__6419__i;}
  args = new cljs.core.IndexedSeq(G__6419__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__6420){
var args = cljs.core.seq(arglist__6420);
...
return cljs.core.get_in.call(null,new_db,p1__6421_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__6422_SHARP_){
return cljs.core.get_in.call(null,db,p1__6422_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__6423__i = 0, G__6423__a = new Array(arguments.length -  2);
while (G__6423__i < G__6423__a.length) {G__6423__a[G__6423__i] = arguments[G__6423__i + 2]; ++G__6423__i;}
  in_paths = new cljs.core.IndexedSeq(G__6423__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__6424){
var f = cljs.core.first(arglist__6424);
arglist__6424 = cljs.core.next(arglist__6424);
var out_path = cljs.core.first(arglist__6424);
var in_paths = cljs.core.rest(arglist__6424);
...
//# sourceMappingURL=middleware.js.map?rel=1459672175847